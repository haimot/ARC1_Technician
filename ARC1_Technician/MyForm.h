...
private: System::Windows::Forms::Button^  B_Draw_Rectangle;
		...
		void InitializeComponent(void)
		{
			...
			this->B_Draw_Rectangle = (gcnew System::Windows::Forms::Button());
			...
			this->B_MAP_PANEL->Controls->Add(this->B_Draw_Rectangle);
			...
			// B_Draw_Rectangle
			// 
			this->B_Draw_Rectangle->Location = System::Drawing::Point(692, 158);
			this->B_Draw_Rectangle->Name = L"B_Draw_Rectangle";
			this->B_Draw_Rectangle->Size = System::Drawing::Size(111, 31);
			this->B_Draw_Rectangle->TabIndex = 219;
			this->B_Draw_Rectangle->Text = L"Draw Rectangle";
			this->B_Draw_Rectangle->UseVisualStyleBackColor = true;
			this->B_Draw_Rectangle->Click += gcnew System::EventHandler(this, &MyForm::B_Draw_Triangle_Click);
			// 
			// B_LOAD_MAP
			// 
			...
			chartArea1->AxisX->Interval = 1000;
			chartArea1->AxisX->IsMarksNextToAxis = false;
			chartArea1->AxisX->LabelStyle->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 6));
			chartArea1->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea1->AxisX->LineColor = System::Drawing::Color::Silver;
			chartArea1->AxisX->MajorGrid->LineColor = System::Drawing::Color::Silver;
			chartArea1->AxisX->MajorTickMark->Enabled = false;
			chartArea1->AxisX->Maximum = 4000;
			...
			chartArea1->AxisY->LabelStyle->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 6));
			...
			chartArea1->Position->Height = 95;
			chartArea1->Position->Width = 95;
			chartArea1->Position->X = 5;
			this->PB_MAP_chart->ChartAreas->Add(chartArea1);
			legend1->Enabled = false;
			legend1->Name = L"Legend1";
			this->PB_MAP_chart->Legends->Add(legend1);
			...
			series2->MarkerColor = System::Drawing::Color::Magenta;
			series2->MarkerSize = 7;
			series2->MarkerStyle = System::Windows::Forms::DataVisualization::Charting::MarkerStyle::Circle;
			series2->Name = L"targets_pylons";
			this->PB_MAP_chart->Series->Add(series1);
			this->PB_MAP_chart->Series->Add(series2);
			...
			chartArea2->AxisX->LabelStyle->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14));
			chartArea2->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea2->AxisX->LineColor = System::Drawing::Color::White;
			chartArea2->AxisX->LineWidth = 2;
			chartArea2->AxisX->MajorGrid->LineColor = System::Drawing::Color::White;
			chartArea2->AxisX->MajorTickMark->LineColor = System::Drawing::Color::White;
			chartArea2->AxisX->Maximum = 180;
			chartArea2->AxisX->Minimum = -180;
			chartArea2->AxisX->TitleForeColor = System::Drawing::Color::White;
			chartArea2->AxisY->Interval = 250;
			chartArea2->AxisY->IsLabelAutoFit = false;
			chartArea2->AxisY->LabelStyle->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			...
			chartArea2->Position->Height = 95;
			chartArea2->Position->Width = 95;
			chartArea2->Position->X = 5;
			this->B_RADAR_PLOT->ChartAreas->Add(chartArea2);
			legend2->Enabled = false;
			legend2->Name = L"Legend1";
			this->B_RADAR_PLOT->Legends->Add(legend2);
			...
			series3->CustomProperties = L"EmptyPointValue=Zero";
			series3->IsVisibleInLegend = false;
			series3->LabelAngle = 90;
			series3->Legend = L"Legend1";
			series3->MarkerColor = System::Drawing::Color::Red;
			series3->Name = L"Wires";
			this->B_RADAR_PLOT->Series->Add(series3);
			...
			chartArea3->AxisX->Interval = 200;
			chartArea3->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea3->AxisX->Maximum = 1024;
			chartArea3->AxisX->Minimum = 0;
			chartArea3->AxisX->TitleForeColor = System::Drawing::Color::White;
			chartArea3->AxisY->Interval = 0.5;
			chartArea3->AxisY->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea3->AxisY->Maximum = 1;
			chartArea3->AxisY->Minimum = -1;
			chartArea3->IsSameFontSizeForAllAxes = true;
			chartArea3->Name = L"Left_H";
			chartArea4->AxisX->Interval = 200;
			chartArea4->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea4->AxisX->Maximum = 1024;
			chartArea4->AxisX->Minimum = 0;
			chartArea4->AxisY->Interval = 0.5;
			chartArea4->AxisY->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea4->AxisY->Maximum = 1;
			chartArea4->AxisY->Minimum = -1;
			chartArea4->Name = L"Left_V";
			chartArea5->AxisX->Interval = 200;
			chartArea5->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea5->AxisX->Maximum = 1024;
			chartArea5->AxisX->Minimum = 0;
			chartArea5->AxisY->Interval = 0.5;
			chartArea5->AxisY->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea5->AxisY->Maximum = 1;
			chartArea5->AxisY->Minimum = -1;
			chartArea5->Name = L"Right_H";
			chartArea6->AxisX->Interval = 200;
			chartArea6->AxisX->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea6->AxisX->Maximum = 1024;
			chartArea6->AxisX->Minimum = 0;
			chartArea6->AxisY->Interval = 0.5;
			chartArea6->AxisY->LabelStyle->ForeColor = System::Drawing::Color::White;
			chartArea6->AxisY->Maximum = 1;
			chartArea6->AxisY->Minimum = -1;
			chartArea6->Name = L"Right_V";
			this->B_PROBE_TEST_PLOT->ChartAreas->Add(chartArea3);
			this->B_PROBE_TEST_PLOT->ChartAreas->Add(chartArea4);
			this->B_PROBE_TEST_PLOT->ChartAreas->Add(chartArea5);
			this->B_PROBE_TEST_PLOT->ChartAreas->Add(chartArea6);
			legend3->Enabled = false;
			legend3->Name = L"Legend1";
			this->B_PROBE_TEST_PLOT->Legends->Add(legend3);
			...
			series4->ChartArea = L"Left_H";
			series4->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series4->Color = System::Drawing::Color::Blue;
			series4->Label = L"I";
			series4->Legend = L"Legend1";
			series4->LegendText = L"I";
			series4->Name = L"LH_I";
			series5->BorderWidth = 2;
			series5->ChartArea = L"Left_H";
			series5->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series5->Color = System::Drawing::Color::Red;
			series5->Label = L"Q";
			series5->Legend = L"Legend1";
			series5->LegendText = L"Q";
			series5->Name = L"LH_Q";
			series6->BorderWidth = 2;
			series6->ChartArea = L"Left_V";
			series6->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series6->Color = System::Drawing::Color::Blue;
			series6->Label = L"I";
			series6->Legend = L"Legend1";
			series6->LegendText = L"I";
			series6->Name = L"LV_I";
			series7->BorderWidth = 2;
			series7->ChartArea = L"Left_V";
			series7->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series7->Color = System::Drawing::Color::Red;
			series7->Legend = L"Legend1";
			series7->LegendText = L"Q";
			series7->Name = L"LV_Q";
			series8->BorderWidth = 2;
			series8->ChartArea = L"Right_H";
			series8->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series8->Color = System::Drawing::Color::Blue;
			series8->Legend = L"Legend1";
			series8->LegendText = L"I";
			series8->Name = L"RH_I";
			series9->BorderWidth = 2;
			series9->ChartArea = L"Right_H";
			series9->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series9->Color = System::Drawing::Color::Red;
			series9->Legend = L"Legend1";
			series9->LegendText = L"Q";
			series9->Name = L"RH_Q";
			series10->BorderWidth = 2;
			series10->ChartArea = L"Right_V";
			series10->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series10->Color = System::Drawing::Color::Blue;
			series10->Legend = L"Legend1";
			series10->LegendText = L"I";
			series10->Name = L"RV_I";
			series11->BorderWidth = 2;
			series11->ChartArea = L"Right_V";
			series11->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::FastLine;
			series11->Color = System::Drawing::Color::Red;
			series11->Legend = L"Legend1";
			series11->LegendText = L"Q";
			series11->Name = L"RV_Q";
			series11->Points->Add(dataPoint1);
			this->B_PROBE_TEST_PLOT->Series->Add(series4);
			this->B_PROBE_TEST_PLOT->Series->Add(series5);
			this->B_PROBE_TEST_PLOT->Series->Add(series6);
			this->B_PROBE_TEST_PLOT->Series->Add(series7);
			this->B_PROBE_TEST_PLOT->Series->Add(series8);
			this->B_PROBE_TEST_PLOT->Series->Add(series9);
			this->B_PROBE_TEST_PLOT->Series->Add(series10);
			this->B_PROBE_TEST_PLOT->Series->Add(series11);
			...
			chartArea7->AxisX->Maximum = 1000;
			chartArea7->AxisX->Minimum = 0;
			chartArea7->AxisX->Title = L"Range [m]";
			...
			chartArea7->AxisY->Maximum = 0;
			chartArea7->AxisY->Minimum = -80;
			chartArea7->AxisY->Title = L"Amplitude [dB]";
			chartArea7->AxisY->TitleForeColor = System::Drawing::Color::White;
			chartArea7->BackColor = System::Drawing::Color::Black;
			chartArea7->Name = L"ChartArea1";
			this->B_SCOPE_V_RIGHT->ChartAreas->Add(chartArea7);
			...
			title1->Text = L"V - right";
			this->B_SCOPE_V_RIGHT->Titles->Add(title1);
			// 
			// B_SCOPE_V_LEFT
			// 
			this->B_SCOPE_V_LEFT->BackColor = System::Drawing::Color::Black;
			chartArea8->AxisX->Interval = 100;
			...
			chartArea8->AxisX->Maximum = 1000;
			chartArea8->AxisX->Minimum = 0;
			chartArea8->AxisX->Title = L"Range [m]";
			...
			chartArea8->AxisY->Maximum = 0;
			chartArea8->AxisY->Minimum = -80;
			chartArea8->AxisY->Title = L"Amplitude [dB]";
			chartArea8->AxisY->TitleForeColor = System::Drawing::Color::White;
			chartArea8->BackColor = System::Drawing::Color::Black;
			chartArea8->Name = L"ChartArea1";
			this->B_SCOPE_V_LEFT->ChartAreas->Add(chartArea8);
			legend5->Enabled = false;
			legend5->Name = L"Legend1";
			this->B_SCOPE_V_LEFT->Legends->Add(legend5);
			...
			series19->Name = L"Average2";
			this->B_SCOPE_V_LEFT->Series->Add(series16);
			this->B_SCOPE_V_LEFT->Series->Add(series17);
			this->B_SCOPE_V_LEFT->Series->Add(series18);
			this->B_SCOPE_V_LEFT->Series->Add(series19);
			...
			title2->Text = L"V - left";
			this->B_SCOPE_V_LEFT->Titles->Add(title2);
			// 
			// B_SCOPE_H_RIGHT
			// 
			this->B_SCOPE_H_RIGHT->BackColor = System::Drawing::Color::Black;
			chartArea9->AxisX->Interval = 100;
			...
			chartArea9->AxisX->Maximum = 1000;
			chartArea9->AxisX->Minimum = 0;
			chartArea9->AxisX->Title = L"Range [m]";
			chartArea9->AxisX->TitleForeColor = System::Drawing::Color::White;
			chartArea9->AxisY->Interval = 10;
			...
			chartArea9->AxisY->Maximum = 0;
			chartArea9->AxisY->Minimum = -80;
			chartArea9->AxisY->Title = L"Amplitude [dB]";
			...
			this->B_SCOPE_H_RIGHT->ChartAreas->Add(chartArea9);
			legend6->Enabled = false;
			legend6->Name = L"Legend1";
			this->B_SCOPE_H_RIGHT->Legends->Add(legend6);
			...
			series22->Name = L"Single2";
			series23->BorderWidth = 2;
			series23->ChartArea = L"ChartArea1";
			series23->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::Line;
			series23->Color = System::Drawing::Color::Aqua;
			series23->Legend = L"Legend1";
			series23->Name = L"Average2";
			this->B_SCOPE_H_RIGHT->Series->Add(series20);
			this->B_SCOPE_H_RIGHT->Series->Add(series21);
			this->B_SCOPE_H_RIGHT->Series->Add(series22);
			this->B_SCOPE_H_RIGHT->Series->Add(series23);
			...
			title3->Text = L"H - right";
			this->B_SCOPE_H_RIGHT->Titles->Add(title3);
			// 
			// B_SCOPE_H_LEFT
			// 
			this->B_SCOPE_H_LEFT->BackColor = System::Drawing::Color::Black;
			chartArea10->AxisX->Interval = 100;
			...
			chartArea10->AxisY->Maximum = 0;
			chartArea10->AxisY->MaximumAutoSize = 80;
			chartArea10->AxisY->Minimum = -80;
			chartArea10->AxisY->ScaleBreakStyle->LineColor = System::Drawing::Color::White;
			chartArea10->AxisY->Title = L"Amplitude [dB]";
			...
			chartArea10->BackHatchStyle = System::Windows::Forms::DataVisualization::Charting::ChartHatchStyle::BackwardDiagonal;
			...
			this->B_SCOPE_H_LEFT->ChartAreas->Add(chartArea10);
			...
			this->B_SCOPE_H_LEFT->Legends->Add(legend7);
			...
			series24->MarkerBorderColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(128)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			series24->Name = L"Single1";
			...
			series25->MarkerBorderColor = System::Drawing::Color::Red;
			series25->Name = L"Average1";
			...
			series26->Name = L"Single2";
			series27->BorderWidth = 2;
			series27->ChartArea = L"ChartArea1";
			series27->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::Line;
			series27->Color = System::Drawing::Color::Aqua;
			series27->Legend = L"Legend1";
			series27->Name = L"Average2";
			this->B_SCOPE_H_LEFT->Series->Add(series24);
			this->B_SCOPE_H_LEFT->Series->Add(series25);
			this->B_SCOPE_H_LEFT->Series->Add(series26);
			this->B_SCOPE_H_LEFT->Series->Add(series27);
			...
			title4->Text = L"H - left";
			this->B_SCOPE_H_LEFT->Titles->Add(title4);
			// 
			// W_DATA_RECORDING
			// 
	...
	/*	Thread^							thread_PC_messaging;
		...
		clock_t							for_debug_timer_7;
		clock_t							for_debug_timer_8;
		...
		//  For QA
		//------------------------------------
		void		B_Draw_Triangle_Click(System::Object^  sender, System::EventArgs^  e);
		//
		//	Review Flight
		//
