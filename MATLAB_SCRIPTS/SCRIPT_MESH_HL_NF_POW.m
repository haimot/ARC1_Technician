...
signal_strength_emp = 20*log10(max(max(abs(TGT_H_left_mf(:)))));
 ...
 Fig_TGT_MESH= figure('units','normalized','outerposition',[0 0 1 1]);
    set(Fig_TGT_MESH,'WindowStyle','docked')
%     subplot(221)
    mesh(Number_of_buffers / 2 - 1:-1:-Number_of_buffers / 2,t,20*log10(TGT_H_left_mf))
    hold on;
%    plot3(ones(1,length(t)),t,20*log10(TGT_H_left_mf_mean)+40,'linewidth',2,'Color','k')
%     view(70,32)
    view(180,0)
...
%  subplot(222)
%     mesh(Number_of_buffers / 2 - 1:-1:-Number_of_buffers / 2,t,20*log10(TGT_H_right_mf))
%     hold on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_H_right_mf_mean)+40,'linewidth',2,'Color','k')
% %     view(70,32)
%     view(180,0)
...
%   
%   subplot(223)
%     mesh(Number_of_buffers / 2 - 1:-1:-Number_of_buffers / 2,t,20*log10(TGT_V_left_mf))
%     hold on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_V_left_mf_mean)+40,'linewidth',2,'Color','k')
% %     view(70,32)
%     view(180,0)
...
%     
%   subplot(224)
%     mesh(Number_of_buffers / 2 - 1:-1:-Number_of_buffers / 2,t,20*log10(TGT_V_right_mf))
%     hold on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_V_right_mf_mean)+40,'linewidth',2,'Color','k')
% %     view(70,32)
%     view(180,0)
...
%     subplot(1,4,1)
%     [sample,buffer_num]=my_max_matrix(20*log10(TGT_H_left_mf));
%    bar(sample(1) - width:sample(1) + width,20*log10(TGT_H_left_mf(sample(1) - width:sample(1) + width,buffer_num)),'BaseValue',-100)
...
%        bar(sample(1) - width:sample(1) + width,20*log10(TGT_H_right_mf(sample(1) - width:sample(1) + width,buffer_num)),'BaseValue',-100)
...
%       bar(sample(1) - width:sample(1) + width,20*log10(TGT_V_left_mf(sample(1) - width:sample(1) + width,buffer_num)),'BaseValue',-100)
...
%    bar(sample(1) - width:sample(1) + width,20*log10(TGT_V_right_mf(sample(1) - width:sample(1) + width,buffer_num)),'BaseValue',-100)
...
%     subplot(1,4,1)
%     [sample,buffer_num]=my_max_matrix(20*log10(TGT_H_left_mf));
%      bar(width:-1:-width,20*log10(TGT_H_left_mf(sample(1),buffer_num - width : buffer_num + width)),'BaseValue',-100)
% %     mesh(width:-1:-width,-width:width,20*log10(TGT_H_left_mf(sample(1) - width: sample(1) + width,buffer_num(1) - width:buffer_num(1) + width)))
%     hold on;
%     grid on;
% %    plot3(ones(1,length(t)),t,20*log10(TGT_H_left_mf_mean)+40,'linewidth',2,'Color','k')
...
%  subplot(1,4,2)
%      [sample,buffer_num]=my_max_matrix(20*log10(TGT_H_right_mf));
%           bar(width:-1:-width,20*log10(TGT_H_right_mf(sample(1),buffer_num - width : buffer_num + width)),'BaseValue',-100)
% %    mesh(width:-1:-width,-width:width,20*log10(TGT_H_right_mf(sample(1) - width: sample(1) + width,buffer_num(1) - width:buffer_num(1) + width)))
%     hold on;
%     grid on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_H_right_mf_mean)+40,'linewidth',2,'Color','k')
...
%   subplot(1,4,3)
%      [sample,buffer_num]=my_max_matrix(20*log10(TGT_V_left_mf));
%         bar(width:-1:-width,20*log10(TGT_V_left_mf(sample(1),buffer_num - width : buffer_num + width)),'BaseValue',-100)
% %      mesh(width:-1:-width,-width:width,20*log10(TGT_V_left_mf(sample(1) - width: sample(1) + width,buffer_num(1) - width:buffer_num(1) + width)))
%     hold on;
%     grid on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_V_left_mf_mean)+40,'linewidth',2,'Color','k')
...
%   subplot(1,4,4)
%    [sample,buffer_num]=my_max_matrix(20*log10(TGT_V_right_mf));
%            bar(width:-1:-width,20*log10(TGT_V_right_mf(sample(1),buffer_num - width : buffer_num + width)),'BaseValue',-100)
% %     mesh(width:-1:-width,-width:width,20*log10(TGT_V_right_mf(sample(1) - width: sample(1) + width,buffer_num(1) - width:buffer_num(1) + width)))
%     hold on;
%     grid on;
% %     plot3(ones(1,length(t)),t,20*log10(TGT_V_right_mf_mean)+40,'linewidth',2,'Color','k')
