...
buffer_H_left_I = buffer_A(1+4:4:4*CPI_LENGTH,:);
buffer_H_left_Q = buffer_A(2+4:4:4*CPI_LENGTH,:);
buffer_V_left_I = buffer_A(3+4:4:4*CPI_LENGTH,:);
buffer_V_left_Q = buffer_A(4+4:4:4*CPI_LENGTH,:);
buffer_H_right_I = buffer_B(1+4:4:4*CPI_LENGTH,:);
buffer_H_right_Q = buffer_B(2+4:4:4*CPI_LENGTH,:);
buffer_V_right_I = buffer_B(3+4:4:4*CPI_LENGTH,:);
buffer_V_right_Q = buffer_B(4+4:4:4*CPI_LENGTH,:);
