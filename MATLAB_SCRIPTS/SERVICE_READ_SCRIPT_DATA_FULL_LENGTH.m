...
Number_of_buffers = DET_algorithms(3);
Maximal_doppler = floor(DET_algorithms(5)/(2^16));
Target_detection_1st_threshold = DET_algorithms(5) - Maximal_doppler * (2^16);
Rx_correction = double(Rx_correction);
%-------------------------------------------------
...
buffer_H_left_I = real( buffer_H_left );
buffer_H_left_Q = imag( buffer_H_left );
buffer_V_left_I = real( buffer_V_left );
buffer_V_left_Q = imag( buffer_V_left );
buffer_H_right_I = real( buffer_H_right );
buffer_H_right_Q = imag( buffer_H_right );
buffer_V_right_I = real( buffer_V_right );
buffer_V_right_Q = imag( buffer_V_right );
